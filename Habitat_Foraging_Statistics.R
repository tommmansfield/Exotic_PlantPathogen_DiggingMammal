...
rd_dist.df 
write.csv(rd_dist.df, "C:/Users/rd_dist.csv") # locate the file that this should be put into
...
write.csv(q_rd_dist.df, "C:/Users/quail_dist.csv") # locate the file that this should be put into
